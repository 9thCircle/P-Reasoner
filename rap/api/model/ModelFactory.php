...
class ModelFactory
{
	...
	*/
	...
	{
		return self::getMemModel($baseURI);
	}
	...
	*/
	...
	{
		$dbStore = self::getDbStore();
		$m = self::getDbModel($dbStore,$baseURI);
		return $m;
	}
	...
	*/
	public static function getResModel($modelType, $baseURI = NULL)
	{
		switch ($modelType) {
			case DBMODEL:
				$baseModel = self::getDefaultDbModel($baseURI);
				break;

			case INFMODELF:
				$baseModel = self::getInfModelF($baseURI);
				break;

			case INFMODELB:
				$baseModel = self::getInfModelB($baseURI);
				break;

			default:
				$baseModel = self::getMemModel($baseURI);
				break;
		}
		return self::getResModelForBaseModel($baseModel);
	}
	...
	*/
	public static function getOntModel($modelType,$vocabulary, $baseURI = NULL)
	{
        ...
        $mod = self::getOntModelForBaseModel($baseModel, $vocabulary);
        return $mod;
	}
